...
import net.mcreator.scpadditions.procedures.GlassPlayerFinishesUsingItemProcedure;
...
public class GlassItem extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:glass")
	public static final Item block = null;

	public GlassItem(ScpAdditionsModElements instance) {
		super(instance, 407);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			GlassPlayerFinishesUsingItemProcedure
