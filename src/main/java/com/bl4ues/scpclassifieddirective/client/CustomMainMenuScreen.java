...
import com.bl4ues.scpclassifieddirective.config.ui.ClientPreferencesMenu;
...
/**
 * SCP: Classified Directive title presentation. The class intentionally remains a
...
public final class CustomMainMenuScreen extends TitleScreen {
    private static final ResourceLocation MENU_OVERLAY = new ResourceLocation(
            ScpClassifiedDirectiveMod.MODID, "textures/screens/menu_background.png");
    private static final ResourceLocation FALLBACK_BACKGROUND = new ResourceLocation(
            ScpClassifiedDirectiveMod.MODID, "textures/screens/menu/loading_screen.png");
    private static final ResourceLocation SPINNER_OUTER = new ResourceLocation(
            ScpClassifiedDirectiveMod.MODID, "textures/screens/menu/loading_1.png");
    private static final ResourceLocation SPINNER_INNER = new ResourceLocation(
            ScpClassifiedDirectiveMod.MODID, "textures/screens/menu/loading_2.png");
