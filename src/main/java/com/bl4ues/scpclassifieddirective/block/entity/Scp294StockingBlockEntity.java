...
public class Scp294StockingBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(1, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public Scp294StockingBlockEntity(BlockPos position, BlockState state) {
		super(ScpClassifiedDirectiveModBlockEntities.SCP_294_STOCKING.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("scp_294_stocking");
	}
