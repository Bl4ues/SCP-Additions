...
public class Scp0591infected3Entity extends ScpAdditionsModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(null)).setRegistryName("scp_0591infected_3_spawn_egg"));
	}
