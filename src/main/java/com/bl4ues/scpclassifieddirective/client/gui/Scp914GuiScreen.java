...
import com.bl4ues.scpclassifieddirective.network.Scp914GuiButtonMessage;
import com.bl4ues.scpclassifieddirective.world.inventory.Scp914GuiMenu;
...
public class Scp914GuiScreen extends AbstractContainerScreen<Scp914GuiMenu> {
	...
	private static final ResourceLocation BACKGROUND = new ResourceLocation("scp_classified_directive:textures/screens/scp_914_gui.png");
	private static final ResourceLocation DIAL = new ResourceLocation("scp_classified_directive:textures/screens/scp_914_dial.png");
	private static final ResourceLocation DIAL_HOVER = new ResourceLocation("scp_classified_directive:textures/screens/scp_914_dial_hover.png");
	...
	private void selectSetting(DialSetting setting, boolean sendPacket) {
		...
		if (sendPacket && changed) {
			ScpClassifiedDirectiveMod.PACKET_HANDLER.sendToServer(new Scp914GuiButtonMessage(setting.buttonId, x, y, z));
		}
	}
	...
	private DialSetting currentSettingFromBlock() {
		...
		if (block == ScpClassifiedDirectiveModBlocks.SCP_914DIAL_ROUGH.get()) return DialSetting.ROUGH;
		if (block == ScpClassifiedDirectiveModBlocks.SCP_914DIAL_COARSE.get()) return DialSetting.COARSE;
		if (block == ScpClassifiedDirectiveModBlocks.SCP_914DIAL_FINE.get()) return DialSetting.FINE;
		if (block == ScpClassifiedDirectiveModBlocks.SCP_914DIAL_VERY_FINE.get()) return DialSetting.VERY_FINE;
