...
import com.bl4ues.scpclassifieddirective.network.MineZeroLoadVotePacket;
...
public final class MineZeroClientState {
    ...
    public static void receiveState(boolean openScreen, String cause,
        ...
        // spectate coordinator first presents CONNECTION LOST/static, then the
        // client retracts the feed after that sting has finished.
    ...
    public static void voteToRestore() {
        ...
        ScpClassifiedDirectiveMod.PACKET_HANDLER.sendToServer(new MineZeroLoadVotePacket());
    }
