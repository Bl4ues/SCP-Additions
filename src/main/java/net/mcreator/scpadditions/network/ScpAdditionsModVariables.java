...
public class ScpAdditionsModVariables {
	...
	public static class WorldVariables extends SavedData {
		...
		public static final SavedData.Factory<WorldVariables> FACTORY =
				new SavedData.Factory<>(WorldVariables::new, WorldVariables::load, DataFixTypes.LEVEL, DataFixTypes.LEVEL, DataFixTypes.LEVEL);
	...
	public static class MapVariables extends SavedData {
		...
		public static final SavedData.Factory<MapVariables> FACTORY =
				new SavedData.Factory<>(MapVariables::new, MapVariables::load, DataFixTypes.LEVEL, DataFixTypes.LEVEL, DataFixTypes.LEVEL);
