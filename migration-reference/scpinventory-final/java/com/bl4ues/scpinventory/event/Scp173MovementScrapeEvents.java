...
public final class Scp173MovementScrapeEvents {
    ...
    private static void updateMovementScrape(Scp173Entity scp173) {
        ...
        if (previous.distanceToSqr(current) <= MIN_MOVEMENT_SQR) {
            return;
        }
        ...
        NEXT_SCRAPE_TICK.put(id, scp173.tickCount + SCRAPE_INTERVAL_TICKS + scp173.getRandom().nextInt(SCRAPE_RANDOM_INTERVAL_TICKS + 1));
    }
}
