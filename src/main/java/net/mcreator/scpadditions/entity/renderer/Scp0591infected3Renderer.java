...
package net.mcreator.scpadditions.entity.renderer;
...
@OnlyIn(Dist.CLIENT)
public class Scp0591infected3Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Scp0591infected3Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelscp059infected3(), 0.5f) {
					{
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn
					.getBuffer(RenderType.getEyes(new ResourceLocation("scp_additions:textures/entities/scp059_1.png")));
