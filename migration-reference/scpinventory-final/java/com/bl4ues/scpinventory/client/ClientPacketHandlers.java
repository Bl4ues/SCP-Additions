...
public final class ClientPacketHandlers {
    ...
    public static void showScp131Notice(boolean following) {
        InventoryFullOverlay.showPodNotice(following);
    }

    public static void setBlinkWatcherActive(boolean active) {
        BlinkClient.setActive(active);
    }
