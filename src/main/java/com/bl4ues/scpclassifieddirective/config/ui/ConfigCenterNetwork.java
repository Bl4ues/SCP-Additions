    ...
    public static final class OpenRequest {
        ...
        public static void handle(OpenRequest ignored, Supplier<NetworkEvent.Context> supplier) {
            ...
            context.enqueueWork(() -> {
                ...
                if (player != null) {
                    openFor(player,
                            com.bl4ues.scpclassifieddirective.inventory.network.ModNetwork.CHANNEL);
                }
            });
    ...
    public record SaveRequest(String changes) {
        ...
        public static void handle(SaveRequest message, Supplier<NetworkEvent.Context> supplier) {
            ...
            context.enqueueWork(() -> {
                ...
                if (result.success()) {
                    com.bl4ues.scpclassifieddirective.inventory.network.ModNetwork.syncModuleState(
                ...
                com.bl4ues.scpclassifieddirective.inventory.network.ModNetwork.CHANNEL.send(
