...
public class PickupItemPacket {
    ...
    private static void playPickupFeedback(ServerPlayer player, ItemEntity itemEntity, int acceptedCount) {
        // The custom cue reaches the client first so it can arm a very short
        // suppression window for the vanilla sound generated by take(). This
        // preserves Minecraft's pickup animation without layering two sounds.
