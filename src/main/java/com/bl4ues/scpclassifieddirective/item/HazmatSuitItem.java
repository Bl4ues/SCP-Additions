...
import com.bl4ues.scpclassifieddirective.equipment.HazmatSuitManager;
...
public final class HazmatSuitItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, Level level,
        ...
        tooltip.add(Component.translatable(
                "tooltip.scp_classified_directive.hazmat_suit.sealed")
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable(
                "tooltip.scp_classified_directive.hazmat_suit.armor")
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable(
                "tooltip.scp_classified_directive.hazmat_suit.equip")
                .withStyle(ChatFormatting.DARK_GRAY));
        tooltip.add(Component.translatable(
                "tooltip.scp_classified_directive.hazmat_suit.remove")
                .withStyle(ChatFormatting.DARK_GRAY));
