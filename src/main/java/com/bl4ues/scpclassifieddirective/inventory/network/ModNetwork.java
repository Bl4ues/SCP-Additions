...
import com.bl4ues.scpclassifieddirective.config.ui.ConfigCenterNetwork;
    ...
    public static void syncServerConfig(ServerPlayer player) {
        ...
        CHANNEL.send(PacketDistributor.PLAYER.with(() -> player),
                new ServerConfigSyncPacket(
                        com.bl4ues.scpclassifieddirective.inventory.config.ScpInventoryConfig.itemRules(),
                        com.bl4ues.scpclassifieddirective.inventory.config.ScpInventoryConfig.itemEffects(),
                        com.bl4ues.scpclassifieddirective.inventory.config.ScpInventoryConfig.codexDocuments(),
                        com.bl4ues.scpclassifieddirective.inventory.config.ScpInventoryConfig.hiddenStatusEffects(),
                        com.bl4ues.scpclassifieddirective.inventory.config.ScpInventoryConfig.scp173Targets(),
                        com.bl4ues.scpclassifieddirective.inventory.context.ContextConfigManager.readConfigJson()));
    }
