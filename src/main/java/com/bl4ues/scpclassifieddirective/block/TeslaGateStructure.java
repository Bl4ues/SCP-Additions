...
public final class TeslaGateStructure {
    ...
    public static void destroyFromCollision(Level level, BlockPos partPos,
            BlockState partState, boolean dropGate) {
        ...
        if (dropGate) {
            Block.popResource(level, controllerPos,
                    new ItemStack(ScpClassifiedDirectiveModBlocks.TESLA_GATE.get()));
        }
    ...
    public static boolean isController(BlockState state) {
        ...
        return block == ScpClassifiedDirectiveModBlocks.TESLA_GATE.get()
                || block == ScpClassifiedDirectiveModBlocks.TESLA_ACTIVE.get()
                || block == ScpClassifiedDirectiveModBlocks.TESLA_RECHARGE.get()
                || block == ScpClassifiedDirectiveModBlocks.TESLA_ACTIVE_2.get()
                || block == ScpClassifiedDirectiveModBlocks.TESLA_ACTIVE_3.get()
                || block == ScpClassifiedDirectiveModBlocks.TESLA_ACTIVE_4.get();
    }
