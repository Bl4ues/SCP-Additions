...
public class Scp294GuiSlotMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		ScpClassifiedDirectiveMod.addNetworkMessage(Scp294GuiSlotMessage.class, Scp294GuiSlotMessage::buffer, Scp294GuiSlotMessage::new, Scp294GuiSlotMessage::handler);
	}
}
