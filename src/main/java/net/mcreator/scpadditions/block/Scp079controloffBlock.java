...
public class Scp079controloffBlock extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:scp_079controloff")
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("scp_079controloff");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent(
					"Place it directly at redstone activated blocks like doors to make it possible for SCP-079 to control it."));
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			Scp079controloffUpdateTickProcedure.executeProcedure(Stream
