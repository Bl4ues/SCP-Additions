...
import com.bl4ues.scpclassifieddirective.inventory.network.ItemConfigOpenRequestPacket;
...
public final class ContextConfigClientEvents {
    ...
    private static ItemStack findHoveredScpInventoryStack(Minecraft mc) {
        if (mc.screen == null || !"com.bl4ues.scpclassifieddirective.inventory.client.gui.ScpInventoryScreen".equals(mc.screen.getClass().getName())) {
            return ItemStack.EMPTY;
        }
        try {
