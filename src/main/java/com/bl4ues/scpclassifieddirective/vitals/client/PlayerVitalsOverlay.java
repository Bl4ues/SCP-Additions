...
public final class PlayerVitalsOverlay {
    private static final ResourceLocation STAMINA_ICON =
            new ResourceLocation("scp_classified_directive", "textures/gui/stamina.png");
    private static final ResourceLocation HEALTH_ICON =
            new ResourceLocation("scp_classified_directive", "textures/gui/healthlogo.png");
    private static final ResourceLocation ROBOTO_FONT =
            new ResourceLocation("scp_classified_directive", "roboto");
    ...
    private static final int WITHER_HEALTH_LEFT = 0xF0060403;
    private static final int WITHER_HEALTH_RIGHT = 0xFF2A170E;
    ...
    public static void render(GuiGraphics graphics, int screenWidth,
        ...
        if (VitalsModule.healthHudEnabled()) {
            ...
            int healthColor = withered
                    ? WITHER_HEALTH_RIGHT
                    : bleeding ? BLEEDING_HEALTH_RIGHT : getHealthColor(healthRatio);
            int healthDark = withered
                    ? WITHER_HEALTH_LEFT
                    : bleeding ? BLEEDING_HEALTH_LEFT : darken(healthColor, 0.62F);
