...
public class Scp294GuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Scp294GuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ScpAdditionsModMenus.SCP_294_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 142, 27) {
			...
			public boolean mayPlace(ItemStack stack) {
				return ScpAdditionsModItems.COIN.get() == stack.getItem();
			}
		}));
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			ScpAdditionsMod.PACKET_HANDLER.sendToServer(new Scp294GuiSlotMessage(slotid, x, y, z, ctype, meta));
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof Scp294GuiMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			Scp294CoinSlotProcedure.execute(world, x, y, z, entity);
		}
	}
}
