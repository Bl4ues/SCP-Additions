...
public final class ScpSignHazards {
    ...
    public static final List<Option> OPTIONS = List.of(
            ...
            new Option("self_replicating_object", "Self-Replicating Object"),
            ...
            new Option("self_evolving_system", "Self-Evolving System"),
            new Option("hive_mind_organisms", "Hive-Mind Organisms"),
            new Option("electrical_hazard", "Electrical Hazard"),
            new Option("biological_hazard", "Biological Hazard"),
    ...
    private static Map<String, Option> buildIndex() {
        ...
        for (Option option : OPTIONS) result.put(option.id(), option);
        return Map.copyOf(result);
    }

    public static Option option(String id) {
        return BY_ID.getOrDefault(normalizeId(id), NONE);
    }
    ...
    public static String normalizeId(String id) {
        ...
        String normalized = id.trim().toLowerCase(Locale.ROOT)
                .replace('-', '_').replace(' ', '_');
        return BY_ID.containsKey(normalized) ? normalized : "";
    }
    ...
    public record Option(String id, String displayName) {
        ...
        public ResourceLocation texture() {
            return new ResourceLocation(ScpAdditionsMod.MODID,
                    "textures/screens/scpsign/hazard_" + id + ".png");
        }
    }
}
