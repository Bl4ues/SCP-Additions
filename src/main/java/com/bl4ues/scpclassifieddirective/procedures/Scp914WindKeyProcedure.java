...
import com.bl4ues.scpclassifieddirective.data.Scp914ActivationWaiter;
...
public class Scp914WindKeyProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        ...
        if (entity instanceof ServerPlayer _player) {
            Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("scp_classified_directive:scp_914_achievement"));
        ...
        if (world instanceof Level _level) {
            if (!_level.isClientSide()) {
                _level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("scp_classified_directive:scp914key")), SoundSource.NEUTRAL, 1, 1);
            } else {
                _level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("scp_classified_directive:scp914key")), SoundSource.NEUTRAL, 1, 1, false);
            }
        }
    ...
    private static Scp914RecipeManager.Setting getSelectedSetting(LevelAccessor world) {
        ScpClassifiedDirectiveModVariables.MapVariables variables = ScpClassifiedDirectiveModVariables.MapVariables.get(world);
