...
public class ItemConfigSavePacket {
    ...
    public ItemConfigSavePacket(String itemId, String type, boolean noStamina) {
    ...
    public static ItemConfigSavePacket decode(FriendlyByteBuf buf) {
        ...
        return new ItemConfigSavePacket(itemId, type, noStamina);
    }
    ...
    public static void handle(ItemConfigSavePacket msg, Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
            ...
            ItemConfigManager.saveRule(player, msg.itemId, msg.type, msg.noStamina);
