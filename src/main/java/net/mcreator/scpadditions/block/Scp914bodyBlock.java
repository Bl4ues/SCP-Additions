...
public class Scp914bodyBlock extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:scp_914body")
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(-16, -16, 17, 32, 21, 16), makeCuboidShape(16, 0, 16, 0, 16, 0))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(32, -16, -1, -16, 21, 0), makeCuboidShape(0, 0, 0, 16, 16, 16))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(17, -16, 32, 16, 21, -16), makeCuboidShape(16, 0, 0, 0, 16, 16))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(-1, -16, -16, 0, 21, 32), makeCuboidShape(0, 0, 16, 16, 16, 0))
