...
public final class ElevatorArrivalOverlay {
    ...
    private static final int OVERLAY_HORIZONTAL_BIAS = 3;
    ...
    public static void render(GuiGraphics graphics, int width, int height) {
        ...
        int clipLeft = Math.max(0,
                overlayCenterX - maximumLineWidth / 2 - 12);
        ...
        drawCenteredScaled(graphics, minecraft, sector,
                overlayCenterX, sectorY, sectorScale, LINE_WHITE);
        ...
        drawCenteredScaled(graphics, minecraft, floor,
                overlayCenterX, floorY, floorScale, LINE_WHITE);
        graphics.disableScissor();

        if (lineWidth > 0) {
            graphics.fill(overlayCenterX - lineWidth / 2, lineY,
                    overlayCenterX + (lineWidth + 1) / 2,
                    lineY + 2, LINE_WHITE);
        }
    ...
    private static void drawCenteredScaled(GuiGraphics graphics,
        ...
        graphics.pose().pushPose();
        graphics.pose().translate(centerX - scaledWidth / 2.0F,
                y, 0.0F);
