package com.bl4ues.scpclassifieddirective.world.features;
...
import com.bl4ues.scpclassifieddirective.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, ScpClassifiedDirectiveMod.MODID);
