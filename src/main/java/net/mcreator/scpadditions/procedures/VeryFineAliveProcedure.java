		...
		if (!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3((x - 4), y, (z - 3)), 4, 4, 4), e -> true).isEmpty()) {
			...
			ScpAdditionsMod.queueServerWork(160, () -> {
				...
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 300, 5, false, false));
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(MobEffects.JUMP, 300, 1, false, false));
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(MobEffects.HEALTH_BOOST, 300, 7, false, false));
				ScpAdditionsMod.queueServerWork(300, () -> {
					if (entity instanceof LivingEntity _entity)
						_entity.hurt(new DamageSource(_entity.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypes.GENERIC)) {
							@Override
							public Component getLocalizedDeathMessage(LivingEntity _msgEntity) {
								String _translatekey = "death.attack." + "scp914veryfine";
		...
		if (!world.getEntitiesOfClass(Cod.class, AABB.ofSize(new Vec3((x - 4), y, (z - 3)), 4, 4, 4), e -> true).isEmpty()) {
			{
				...
				for (Entity entityiterator : _entfound) {
					...
					ScpAdditionsMod.queueServerWork(160, () -> {
						if (world instanceof ServerLevel _level) {
							Entity entityToSpawn = EntityType.GUARDIAN.spawn(_level, BlockPos.containing(x + 4, y, z - 3), MobSpawnType.MOB_SUMMONED);
							if (entityToSpawn != null) {
								entityToSpawn.setDeltaMovement(0, 0, 0);
							}
						}
				...
				for (Entity entityiterator : _entfound) {
					...
					ScpAdditionsMod.queueServerWork(160, () -> {
						if (world instanceof Level _level && !_level.isClientSide())
							_level.explode(null, (x + 4), y, (z - 3), 6, Level.ExplosionInteraction.NONE);
						ScpAdditionsModVariables.MapVariables.get(world).Scp914refining = false;
						ScpAdditionsModVariables.MapVariables.get(world).syncData(world);
					});
				}
		...
		if (!world.getEntitiesOfClass(IronGolem.class, AABB.ofSize(new Vec3((x - 4), y, (z - 3)), 4, 4, 4), e -> true).isEmpty()) {
			{
				...
				for (Entity entityiterator : _entfound) {
					...
					ScpAdditionsMod.queueServerWork(160, () -> {
						...
						if (entityiterator instanceof LivingEntity _entity && !_entity.level().isClientSide())
							_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 10000, 2, false, false));
						if (entityiterator instanceof LivingEntity _entity && !_entity.level().isClientSide())
							_entity.addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 10000, 2, false, false));
						if (entityiterator instanceof LivingEntity _entity && !_entity.level().isClientSide())
