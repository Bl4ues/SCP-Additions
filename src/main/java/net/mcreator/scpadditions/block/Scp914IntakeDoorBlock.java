...
public class Scp914IntakeDoorBlock extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:scp_914_intake_door")
	public static final Block block = null;

	public Scp914IntakeDoorBlock(ScpAdditionsModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("scp_914_intake_door");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(-16, -16, 18, 9, 32, 14))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(32, -16, -2, 7, 32, 2))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(18, -16, 32, 14, 32, 7))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(-2, -16, -16, 2, 32, 9))
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			Scp914IntakeDoorUpdateTickProcedure.executeProcedure(Stream
