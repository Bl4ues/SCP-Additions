...
public class DeconOpenBlock extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:decon_open")
	public static final Block block = null;

	public DeconOpenBlock(ScpAdditionsModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
				...
				default :
					return VoxelShapes
							.or(makeCuboidShape(-16, -16, 32, -13, 32, -16), makeCuboidShape(-16, 32, -16, 16, 19, -13),
									...
									makeCuboidShape(10, -16, 32, 16, 19, 29), makeCuboidShape(16, 19, -16, 10, -16, 0),
									makeCuboidShape(-16, -16, -16, -8, 19, -13), makeCuboidShape(-16, 19, 32, -8, -16, 29),
									makeCuboidShape(-14, 32, 32, 0, 30, -16))
				...
				case NORTH :
					return VoxelShapes
							.or(makeCuboidShape(32, -16, -16, 29, 32, 32), makeCuboidShape(32, 32, 32, 0, 19, 29),
									...
									makeCuboidShape(6, -16, -16, 0, 19, -13), makeCuboidShape(0, 19, 32, 6, -16, 16),
									makeCuboidShape(32, -16, 32, 24, 19, 29), makeCuboidShape(32, 19, -16, 24, -16, -13),
									makeCuboidShape(30, 32, -16, 16, 30, 32))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(32, -16, 32, -16, 32, 29), makeCuboidShape(-16, 32, 32, -13, 19, 0),
							makeCuboidShape(-16, 32, 0, 32, -16, 3), makeCuboidShape(32, 19, 1, 29, 32, 32), makeCuboidShape(32, -16, 32, 29, 19, 24),
							makeCuboidShape(29, 19, 0, 32, -16, 6), makeCuboidShape(-16, -16, 0, -13, 19, 6),
							makeCuboidShape(-13, 19, 24, -16, -16, 32), makeCuboidShape(32, -16, 6, 29, 19, 0),
							makeCuboidShape(-16, 19, 0, 0, -16, 6), makeCuboidShape(-16, -16, 32, -13, 19, 24),
				...
				case WEST :
					return VoxelShapes
							.or(makeCuboidShape(-16, -16, -16, 32, 32, -13), makeCuboidShape(32, 32, -16, 29, 19, 16),
									...
									makeCuboidShape(-16, -16, 10, -13, 19, 16), makeCuboidShape(32, 19, 16, 16, -16, 10),
									makeCuboidShape(32, -16, -16, 29, 19, -8), makeCuboidShape(-16, 19, -16, -13, -16, -8),
									makeCuboidShape(-16, 32, -14, 32, 30, 0))
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			DeconOpenUpdateTickProcedure.executeProcedure(Stream
