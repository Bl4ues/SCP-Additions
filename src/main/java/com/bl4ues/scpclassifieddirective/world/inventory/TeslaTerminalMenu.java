...
public class TeslaTerminalMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public TeslaTerminalMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ScpClassifiedDirectiveModMenus.TESLA_TERMINAL.get(), id);
