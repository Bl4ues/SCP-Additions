...
import net.mcreator.scpadditions.procedures.TeslaActive2BlockAddedProcedure;
...
public class TeslaActive2Block extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:tesla_active_2")
	public static final Block block = null;

	public TeslaActive2Block(ScpAdditionsModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(20f, 100f).setLightLevel(s -> 0).harvestLevel(1)
			...
			setRegistryName("tesla_active_2");
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			TeslaActive2BlockAddedProcedure.executeProcedure(Stream
