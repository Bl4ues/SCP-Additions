...
public class Scp294GuiScreen extends AbstractContainerScreen<Scp294GuiMenu> {
	...
	private static final ResourceLocation BACKGROUND = new ResourceLocation("scp_classified_directive:textures/screens/scp_294_gui.png");
	private static final ResourceLocation COIN_OFF = new ResourceLocation("scp_classified_directive:textures/screens/scp_294_coin_off.png");
	private static final ResourceLocation COIN_ON = new ResourceLocation("scp_classified_directive:textures/screens/scp_294_coin_on.png");
	private static final ResourceLocation SCREEN_OVERLAY = new ResourceLocation("scp_classified_directive:textures/screens/scp_294_screen_overlay.png");
	...
	public boolean mouseClicked(double mouseX, double mouseY, int button) {
		...
		double ty = textureY(mouseY);
		if (contains(COIN_POLY, tx, ty)) {
			ScpClassifiedDirectiveMod.PACKET_HANDLER.sendToServer(new Scp294GuiButtonMessage(1, x, y, z, ""));
			inputFocused = true;
			return true;
		}
	...
	private void sendDrinkRequestAndClose() {
		ScpClassifiedDirectiveMod.PACKET_HANDLER.sendToServer(new Scp294GuiButtonMessage(0, x, y, z, order));
		this.minecraft.player.closeContainer();
	}
