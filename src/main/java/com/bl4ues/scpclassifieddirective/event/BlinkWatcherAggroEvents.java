...
import com.bl4ues.scpclassifieddirective.entity.BlinkWatcherEntity;
...
public final class BlinkWatcherAggroEvents {
    ...
    public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
        ...
        boolean allowed = ScpClassifiedDirectiveModulesConfig.get().scp173.enabled
                && ScpClassifiedDirectiveModulesConfig.get().blink.enabled
