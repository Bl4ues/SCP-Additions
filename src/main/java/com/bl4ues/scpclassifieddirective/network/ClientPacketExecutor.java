...
public final class ClientPacketExecutor {
    private static final String TARGET =
            "com.bl4ues.scpclassifieddirective.client.ClientPacketActions";
    ...
    public static void run(String action) {
        ...
        try {
            ...
            ScpClassifiedDirectiveMod.LOGGER.error("Could not execute client packet action {}", action, exception);
        }
    }
    ...
    private static Method resolve(String action) {
        try {
            ...
            ScpClassifiedDirectiveMod.LOGGER.error("Could not resolve client packet action {}", action, exception);
            return null;
        }
    }
}
