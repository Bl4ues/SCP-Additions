...
import net.mcreator.scpadditions.procedures.GrimaceShakePlayerFinishesUsingItemProcedure;
...
public class GrimaceShakeItem extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:grimace_shake")
	...
	public static class ItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			GrimaceShakePlayerFinishesUsingItemProcedure
