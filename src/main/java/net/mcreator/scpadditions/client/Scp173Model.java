...
public class Scp173Model<T extends Scp173Entity> extends GeoModel<T> {
    private static final ResourceLocation MODEL = new ResourceLocation("scpinventory", "geo/entity/scp_173.geo.json");
    private static final ResourceLocation TEXTURE = new ResourceLocation("scpinventory", "textures/entities/scp_173.png");
    private static final ResourceLocation ANIMATION = new ResourceLocation("scpinventory", "animations/entity/scp_173.animation.json");
