...
public final class ContextConfigManager {
    ...
    private static final String BUNDLED_CONFIG = "config/scp_classified_directive/context_interactions.json";
    ...
    public static void selectLookedBlock(ServerPlayer player) {
        ...
        if (hasRule(selection.id())) {
            ...
            player.sendSystemMessage(Component.literal("[SCP Inventory] Add ").withStyle(ChatFormatting.YELLOW)
                    ...
                    .append(commandButton("[Add]", "/scp_classified_directive context add", ChatFormatting.GREEN, "Create a default interaction entry for this block"))
                    .append(Component.literal(" "))
                    .append(commandButton("[Cancel]", "/scp_classified_directive context cancel", ChatFormatting.RED, "Cancel this selection")));
        }
    }
    ...
    private static void sendSelectedHelp(ServerPlayer player, ResourceLocation id, boolean created) {
        ...
        player.sendSystemMessage(Component.literal("Quick edit: ").withStyle(ChatFormatting.GRAY)
                .append(commandButton("[Anchor Hit]", "/scp_classified_directive context anchor hit", ChatFormatting.YELLOW, "Move anchor to the looked point"))
                .append(Component.literal(" "))
                .append(commandButton("[Hand]", "/scp_classified_directive context item hand", ChatFormatting.WHITE, "Set use item to hand"))
                .append(Component.literal(" "))
                .append(commandButton("[Card]", "/scp_classified_directive context item card", ChatFormatting.AQUA, "Set use item to card"))
                .append(Component.literal(" "))
                .append(commandButton("[Open GUI]", "/scp_classified_directive context gui", ChatFormatting.LIGHT_PURPLE, "Open the visual editor"))
                .append(Component.literal(" "))
                .append(commandButton("[Done]", "/scp_classified_directive context done", ChatFormatting.GREEN, "Close config session")));
        player.sendSystemMessage(Component.literal("Commands: /scp_classified_directive context set action <text>, name <text>, range <value>, input <both|e|right_click>, anchor here <distance>, anchor nudge <x> <y> <z>").withStyle(ChatFormatting.DARK_GRAY));
    }
    ...
    private static File configFile() {
        return new File(new File("config/scp_classified_directive"), "context_interactions.json");
    }
    ...
    private static int noSession(CommandSourceStack source) {
        source.sendFailure(Component.literal("No context config session. Look at a block and press the Context Config key, or run /scp_classified_directive context select."));
        return 0;
    }
