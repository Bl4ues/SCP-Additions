...
import com.bl4ues.scpclassifieddirective.mixin.client.ScreenInvoker;
 ...
 * and rendered as a continuation of SCP: Classified Directive' LAN presentation. Widgets
...
public final class PauseMenuLanCompatibilityClient {
    ...
    private static Backend ensureBackend(CustomPauseMenuScreen parent,
        ...
        try {
            ...
            ((ScreenInvoker) (Object) screen).scpClassifiedDirective$invokeInit(
