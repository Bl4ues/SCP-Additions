...
public class SCP079SystemControlBlock extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:scp_079_system_control")
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("scp_079_system_control");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Activate it with redstone to give control to SCP-079."));
		}
