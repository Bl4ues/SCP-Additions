...
import net.mcreator.scpadditions.procedures.TeslaActive4BProcedure;
...
public class TeslaActive4Block extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:tesla_active_4")
	public static final Block block = null;

	public TeslaActive4Block(ScpAdditionsModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("tesla_active_4");
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			TeslaActive4BProcedure.executeProcedure(Stream
