...
public final class Scp131NoticeOverlay {
    private static final ResourceLocation POD_ICON =
            new ResourceLocation("scp_classified_directive", "textures/gui/131logo.png");
    ...
    public static void show(boolean following) {
        ...
        currentText = following
                ? Component.translatable("notice.scp_classified_directive.scp_131.following",
                        Scp131Keybinds.DISMISS.getTranslatedKeyMessage())
                : Component.translatable("notice.scp_classified_directive.scp_131.stopped");
        active = true;
        shownAt = now;
