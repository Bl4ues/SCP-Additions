...
public final class InventoryModuleRuntimeState {
    ...
    public static boolean requireEquippedWeaponToAttackForClient() {
        ...
        return synced != null ? synced
                : ScpClassifiedDirectiveModulesConfig.get().inventory
