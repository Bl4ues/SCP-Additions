...
import com.bl4ues.scpclassifieddirective.client.Scp079EnergyClientState;
import com.bl4ues.scpclassifieddirective.client.Scp079EnergyClientState.ClientDecisionSnapshot;
...
public final class Scp079EnergyOverlay {
    ...
    private static void renderEnergy(GuiGraphics graphics,
        ...
        ItemStack icon = new ItemStack(ScpClassifiedDirectiveModItems.SCP_079ON.get());
