...
import net.mcreator.scpadditions.procedures.Scp914OutputDoorUpdateTickProcedure;
...
public class Scp914OutputDoorBlock extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:scp_914_output_door")
	public static final Block block = null;

	public Scp914OutputDoorBlock(ScpAdditionsModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(32, -16, 18, 7, 32, 14))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(-16, -16, -2, 9, 32, 2))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(18, -16, -16, 14, 32, 9))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(-2, -16, 32, 2, 32, 7))
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			Scp914OutputDoorUpdateTickProcedure.executeProcedure(Stream
