...
public class TeslaTerminalButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		ScpClassifiedDirectiveMod.addNetworkMessage(TeslaTerminalButtonMessage.class, TeslaTerminalButtonMessage::buffer, TeslaTerminalButtonMessage::new, TeslaTerminalButtonMessage::handler);
	}
}
