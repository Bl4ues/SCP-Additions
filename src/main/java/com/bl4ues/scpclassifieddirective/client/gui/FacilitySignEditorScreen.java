...
import com.bl4ues.scpclassifieddirective.network.FacilitySignClipboardPacket;
import com.bl4ues.scpclassifieddirective.network.FacilitySignSavePacket;
...
public final class FacilitySignEditorScreen extends Screen {
    ...
    private FacilitySignEditorScreen(BlockPos signPos,
        ...
        super(Component.translatable("screen.scp_classified_directive.facility_sign_editor"));
    ...
    protected void init() {
        ...
        for (int index = 0; index < FacilitySignData.ENTRY_COUNT; index++) {
            ...
            if (type.hasNumbers()) {
                EditBox number = new EditBox(font,
                        ...
                        "screen.scp_classified_directive.facility_sign_number"));
            ...
            EditBox text = new EditBox(font, textFrameLeft + 4, rowY + 6,
                    ...
                    "screen.scp_classified_directive.facility_sign_text"));
        ...
        addRenderableWidget(new EditorButton(innerLeft, toolbarY,
                ...
                "screen.scp_classified_directive.facility_sign_copy_all"),
                ButtonStyle.NEUTRAL, this::copyEntireSign));
        addRenderableWidget(new EditorButton(innerLeft + 102, toolbarY,
                96, 20, Component.translatable(
                "screen.scp_classified_directive.facility_sign_paste_all"),
        ...
        addRenderableWidget(new EditorButton(innerLeft + 204, toolbarY,
                ...
                "screen.scp_classified_directive.facility_sign_clear"),
    ...
    private void drawPanel(GuiGraphics graphics) {
        ...
        graphics.drawString(font,
                ScpFonts.montserrat(Component.translatable(
                        "screen.scp_classified_directive.facility_sign_editor")),
        ...
        graphics.drawString(font, ScpFonts.roboto(Component.translatable(
                        type == FacilitySignBlock.SignType.CORE_ROOM
                                ? "block.scp_classified_directive.core_room_sign"
                                : "block.scp_classified_directive.door_sign")),
