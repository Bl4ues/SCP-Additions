...
- Fixed the chase music failing to start because its fade-in began at an unplayable zero volume;
...
- Prevented residual vertical movement from making SCP-106 float during its ground entry or emergence animations;
