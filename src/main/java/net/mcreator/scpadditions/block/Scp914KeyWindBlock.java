...
import net.mcreator.scpadditions.procedures.Scp914WindKeyProcedure;
...
public class Scp914KeyWindBlock extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:scp_914_key_wind")
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(6, 12, 3, 10, 16, 1))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(10, 12, 13, 6, 16, 15))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(3, 12, 10, 1, 16, 6))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(13, 12, 6, 15, 16, 10))
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Scp914WindKeyProcedure.executeProcedure(Stream
