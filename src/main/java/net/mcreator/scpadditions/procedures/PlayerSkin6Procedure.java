...
public class PlayerSkin6Procedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ScpAdditionsMod.LOGGER.warn("Failed to load dependency entity for procedure PlayerSkin6!");
			return;
		}
		...
		if ((entity.getCapability(ScpAdditionsModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new ScpAdditionsModVariables.PlayerVariables())).PlayerOn1to1_6) {
			if (_evt.getRenderer() instanceof PlayerRenderer) {
				...
				new com.kleiders.kleidersplayerrenderer.ClassicPlayerRenderer(_evt.getRenderer().getRenderManager(),
						new ResourceLocation("scp_additions:textures/entities/skin6.png")).render((AbstractClientPlayerEntity) _evt.getEntity(),
