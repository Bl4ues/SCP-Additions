...
import net.mcreator.scpadditions.procedures.TeslaActiveProcedureProcedure;
...
public class TeslaActiveBlock extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:tesla_active")
	public static final Block block = null;

	public TeslaActiveBlock(ScpAdditionsModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			TeslaActiveProcedureProcedure.executeProcedure(Stream
