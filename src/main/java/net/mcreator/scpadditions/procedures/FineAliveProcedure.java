				...
				for (Entity entityiterator : _entfound) {
					...
					new Object() {
						...
						private void run() {
							...
							if (entityiterator instanceof LivingEntity)
								((LivingEntity) entityiterator)
										.addPotionEffect(new EffectInstance(Effects.RESISTANCE, (int) 10000, (int) 1, (false), (false)));
							if (entityiterator instanceof LivingEntity)
								((LivingEntity) entityiterator)
				...
				}.compareDistOf((x - 4), y, (z - 3))).findFirst().orElse(null)) != null) {
			{
				...
				for (Entity entityiterator : _entfound) {
					...
					new Object() {
						...
						private void run() {
							if (world instanceof ServerWorld) {
								Entity entityToSpawn = new PufferfishEntity(EntityType.PUFFERFISH, (World) world);
								entityToSpawn.setLocationAndAngles((x + 4), y, (z - 3), (float) 0, (float) 0);
								entityToSpawn.setRenderYawOffset((float) 0);
								entityToSpawn.setRotationYawHead((float) 0);
								entityToSpawn.setMotion(0, 0, 0);
