...
import net.mcreator.scpadditions.procedures.BleachPlayerFinishesUsingItemProcedure;
...
public class BleachItem extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:bleach")
	...
	public static class ItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			BleachPlayerFinishesUsingItemProcedure
