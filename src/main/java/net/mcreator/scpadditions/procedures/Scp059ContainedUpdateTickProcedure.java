...
public class Scp059ContainedUpdateTickProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				ScpAdditionsMod.LOGGER.warn("Failed to load dependency world for procedure Scp059ContainedUpdateTick!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				ScpAdditionsMod.LOGGER.warn("Failed to load dependency x for procedure Scp059ContainedUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				ScpAdditionsMod.LOGGER.warn("Failed to load dependency y for procedure Scp059ContainedUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				ScpAdditionsMod.LOGGER.warn("Failed to load dependency z for procedure Scp059ContainedUpdateTick!");
			return;
		}
		...
		new Object() {
			...
			private void run() {
				ScpAdditionsModVariables.MapVariables.get(world).RandomX = (x + MathHelper.nextDouble(new Random(), -3, 3));
				ScpAdditionsModVariables.MapVariables.get(world).syncData(world);
				ScpAdditionsModVariables.MapVariables.get(world).RandomY = (y + MathHelper.nextDouble(new Random(), -3, 3));
				ScpAdditionsModVariables.MapVariables.get(world).syncData(world);
				ScpAdditionsModVariables.MapVariables.get(world).RandomZ = (z + MathHelper.nextDouble(new Random(), -3, 3));
				ScpAdditionsModVariables.MapVariables.get(world).syncData(world);
				if (world
