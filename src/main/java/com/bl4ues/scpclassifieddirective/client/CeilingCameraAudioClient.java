...
/** Short-range servo loop for moving ceiling-camera eyes. */
@Mod.EventBusSubscriber(modid = ScpClassifiedDirectiveMod.MODID, value = Dist.CLIENT)
public final class CeilingCameraAudioClient {
    ...
    private CeilingCameraAudioClient() {
    }

    public static void observe(CeilingCameraModule.CeilingCameraBlockEntity camera) {
