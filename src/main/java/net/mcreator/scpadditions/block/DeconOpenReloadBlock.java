...
public class DeconOpenReloadBlock extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:decon_open_reload")
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("decon_open_reload");
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			DeconOpenReloadBlockAddedProcedure.executeProcedure(Stream
