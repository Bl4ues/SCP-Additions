...
import net.mcreator.scpadditions.procedures.GoldCPlayerFinishesUsingItemProcedure;
...
public class GoldCItem extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:gold_c")
	public static final Item block = null;

	public GoldCItem(ScpAdditionsModElements instance) {
		super(instance, 410);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			GoldCPlayerFinishesUsingItemProcedure
