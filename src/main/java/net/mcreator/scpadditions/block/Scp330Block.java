...
public class Scp330Block extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:scp_330")
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Take Only Two"));
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(5, 0, 11, 11, 2, 5))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(11, 0, 5, 5, 2, 11))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(11, 0, 11, 5, 2, 5))
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Scp330CandyDropProcedure.executeProcedure(Stream
