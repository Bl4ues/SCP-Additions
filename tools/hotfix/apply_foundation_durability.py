...
java = r'''package net.mcreator.scpadditions.facility;
...
public final class FacilityBlockMiningEvents {
    ...
    private static void addGeneratedFacilityBlocks(Set<Block> target) {
        ScpAdditionsModBlocks.REGISTRY.getEntries().forEach(entry -> {
...
java_path = ROOT / "src/main/java/net/mcreator/scpadditions/facility/FacilityBlockMiningEvents.java"
java_path.write_text(java, encoding="utf-8")

changelog_path = ROOT / "CHANGELOG.md"
changelog = changelog_path.read_text(encoding="utf-8")
anchor = "## Codex and documents\n"
section = (
    "## Facility durability\n\n"
...
for relative in (
    "tools/hotfix/APPLY_FOUNDATION_DURABILITY",
    "tools/hotfix/apply_foundation_durability.py",
    ".github/workflows/apply-foundation-durability.yml",
):
    path = ROOT / relative
    if path.exists():
        path.unlink()
