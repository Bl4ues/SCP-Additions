 ...
 * authoritative actions and merely receive an SCP: Classified Directive presentation.
 */
public final class CustomPauseMenuScreen extends PauseScreen {
    ...
    /**
     * Opens the SCP: Classified Directive configuration as a continuation of the pause
