...
public class Scp131Model<T extends AbstractScp131Entity> extends GeoModel<T> {
    private static final ResourceLocation MODEL_RESOURCE = new ResourceLocation(ScpInventoryMod.MODID, "geo/entity/scp_131_a.geo.json");
    private static final ResourceLocation ANIMATION_RESOURCE = new ResourceLocation(ScpInventoryMod.MODID, "animations/entity/scp_131_a.animation.json");
