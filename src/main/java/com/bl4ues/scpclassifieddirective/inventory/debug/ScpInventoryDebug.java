package com.bl4ues.scpclassifieddirective.inventory.debug;
...
public final class ScpInventoryDebug {
    ...
    public static final boolean USABLE_DEBUG = Boolean.getBoolean("scp_classified_directive.debugUsable");
