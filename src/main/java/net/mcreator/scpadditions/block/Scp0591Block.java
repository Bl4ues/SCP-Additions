...
public class Scp0591Block extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:scp_059_1")
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			Scp0591UpdateTickProcedure.executeProcedure(Stream
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			Scp0591EntityCollidesInTheBlockProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
