...
public final class SystemTerminalBlockEntityRenderer
    ...
    public SystemTerminalBlockEntityRenderer(
        ...
        // AutoGlowingGeoLayer can be swallowed by shader/PBR wrappers for
        // GeckoLib block entities. Render the authored glowmask explicitly
        // through the vanilla eyes pass so it remains visible and bloom-ready.
