...
path = root / "src/main/java/net/mcreator/scpadditions/facility/elevator/CoreRoomElevatorGeometry.java"
path.write_text('''package net.mcreator.scpadditions.facility.elevator;
