...
import net.mcreator.scpadditions.procedures.SprayRightclickedProcedure;
...
public class SprayItem extends ScpAdditionsModElements.ModElement {
	@ObjectHolder("scp_additions:spray")
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Used to prevent the overgrowth of SCP-059-1."));
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			SprayRightclickedProcedure.executeProcedure(Stream
